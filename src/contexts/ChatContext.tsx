    ...
    if (chats.length > 0) {
      chatChannel.on(
        ...
        (payload) => {
          ...
          fetchChats(); // Re-fetch chats to update last_message_id or chat_name
        }
      );
      ...
      chatChannel.on(
        ...
        (payload) => {
          console.log('New message received in existing chat!', payload);
          fetchChats(); // Re-fetch chats to update last message and unread status
        }
      );
    }
